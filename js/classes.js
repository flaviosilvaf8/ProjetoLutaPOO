...
class Stage {
    ...
    start() {
        ...
        this.fighter1El.querySelector('.attackButton').addEventListener('click', () => {
            return this.doAttack(this.fighter1, this.fighter2);
        });
    ...
    doAttack(attacking, attacked) {
        ...
        if (actualAttack > actualDefense) {
            ...
            this.log.addMsg(`${attacking.name} causou ${actualAttack.toFixed(2)} de dano no ${attacked.name}`)
        } else {
